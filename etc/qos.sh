...
# complex and less flexible than it should, most notably it cannot to my
# knowledge handle IPv6's variable header lengths. It should be rewritten to use
# iptables MARK's to do proper classification (as it does to differentiate
# between source LANs before traffic is masqueraded behind the router's external
# IP address).
